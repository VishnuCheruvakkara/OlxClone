...
// import {collection,addDoc,serverTimestamp} from '../../firebase/FireBase'
            ...
            <main className="max-w-2xl mx-auto p-4">
                ...
                <div className="bg-white rounded-lg shadow-sm p-4 mb-4">
                    ...
                    <div className="mb-4">
                        ...
                        <textarea className="w-full pl-8 pr-4 py-10 border-2 rounded-sm focus:outline-none  focus:border-green-400 border-custom-green" />
                ...
                <button className="bg-gray-200 text-gray-700 px-6 py-2 rounded-lg hover:bg-gray-300 mb-8">
                    Post now
                </button>
            </main>
